...
export const metadata: Metadata = {
  ...
  description:
    "Engineering philosophy, professional career milestones, and technical capabilities of Mitul Kabir Badhon.",
};
    ...
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 space-y-16">
      ...
      <section aria-label="Professional Bio" className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 pt-4">
          <div className="md:col-span-8 space-y-4 text-base sm:text-lg leading-relaxed text-[#9E9E9E]">
            <p>
          ...
          <div className="md:col-span-4 rounded-2xl border border-[#2A2A2A] bg-[#202020] p-6 space-y-4 flex flex-col justify-between">
            <div className="space-y-2">
              <div className="font-mono text-xs font-semibold uppercase tracking-wider text-[#5DD62C]">
                Fast Facts
              </div>
              <ul className="space-y-2 text-xs font-mono text-[#9E9E9E]">
                <li className="flex items-center justify-between border-b border-[#2A2A2A] pb-2">
                  <span>Specialization</span>
                  <span className="text-[#F8F8F8]">Full-Stack / TypeScript</span>
                </li>
                <li className="flex items-center justify-between border-b border-[#2A2A2A] pb-2">
                  <span>Stack</span>
                  <span className="text-[#F8F8F8]">Next.js • Node • Express</span>
                </li>
                <li className="flex items-center justify-between border-b border-[#2A2A2A] pb-2">
                  <span>Database</span>
                  <span className="text-[#F8F8F8]">MongoDB / Mongoose</span>
                </li>
                <li className="flex items-center justify-between">
                  <span>Aesthetics</span>
                  <span className="text-[#5DD62C]">Electric Green Minimalist</span>
                </li>
              </ul>
            </div>
            ...
            <Link
              href="/cv"
              className="inline-flex items-center justify-center gap-2 rounded-lg border border-[#337418] bg-[#5DD62C] px-4 py-2 text-xs font-semibold text-[#0F0F0F] transition-all hover:bg-[#5DD62C]/90 hover:shadow-[0_0_15px_rgba(93,214,44,0.3)]"
            >
      ...
      {/* =========================================================================
          SECTION 2: CORE ENGINEERING PHILOSOPHY
          ========================================================================= */}
      <section aria-labelledby="philosophy-heading" className="space-y-6">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <Terminal className="size-4 text-[#5DD62C]" />
            <span className="font-mono text-xs font-semibold uppercase tracking-wider text-[#5DD62C]">
              Guiding Principles
            </span>
          </div>
          <h2 id="philosophy-heading" className="text-2xl sm:text-3xl font-bold text-[#F8F8F8]">
            Software Engineering Philosophy
          </h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="rounded-xl border border-[#2A2A2A] bg-[#202020] p-6 space-y-3 transition-colors hover:border-[#337418]">
            <div className="flex size-10 items-center justify-center rounded-lg border border-[#2A2A2A] bg-[#0F0F0F] text-[#5DD62C]">
              <Layers className="size-5" />
            </div>
            <h3 className="text-base font-bold text-[#F8F8F8]">Layered Architecture</h3>
            <p className="text-sm leading-relaxed text-[#9E9E9E]">
              Strict separation between domain entities, business repositories, services, and presentation
              layers ensures codebases remain testable, predictable, and resilient to dependency churn.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-[#2A2A2A] bg-[#202020] p-6 space-y-3 transition-colors hover:border-[#337418]">
            ...
            <h3 className="text-base font-bold text-[#F8F8F8]">End-to-End Type Safety</h3>
            <p className="text-sm leading-relaxed text-[#9E9E9E]">
              Rigorous TypeScript schema contracts from database models through REST APIs to React UI
              guarantee deterministic runtime behavior and minimize regressions.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-[#2A2A2A] bg-[#202020] p-6 space-y-3 transition-colors hover:border-[#337418]">
            ...
            <h3 className="text-base font-bold text-[#F8F8F8]">Minimalist Performance</h3>
            <p className="text-sm leading-relaxed text-[#9E9E9E]">
              Sub-second initial loads via Server Components, atomic CSS styling, and zero-bloat libraries.
              Interfaces are constructed with high readability, smooth transitions, and tactile feedback.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* =========================================================================
          SECTION 3: CAREER TIMELINE (Requirement 3 & 5: Vertical Track)
          ========================================================================= */}
      <section aria-labelledby="timeline-heading" className="space-y-6">
        ...
        {hasExperiences ? (
          <div className="relative pl-6 sm:pl-8 ml-2 sm:ml-4 border-l-2 border-[#2A2A2A] space-y-10">
            {sortedExperiences.map((exp) => {
              ...
              return (
                ...
                >
                  {/* Timeline Node on the Vertical Track */}
                  <span
          ...
          <div className="rounded-xl border border-dashed border-[#2A2A2A] bg-[#202020]/40 p-8 sm:p-12 text-center">
            ...
            <h3 className="mt-4 text-base font-semibold text-[#F8F8F8]">
              Career Experience Under Documentation
            </h3>
            <p className="mt-1 text-sm text-[#9E9E9E] max-w-md mx-auto">
              Professional history and educational milestones configured in the administrative dashboard will
              render along this vertical timeline.
            </p>
          </div>
        )}
      </section>
      ...
      {/* =========================================================================
          SECTION 4: SKILLS GROUPED BY CATEGORY WITH PROFICIENCY INDICATORS
          ========================================================================= */}
                  ...
                  {items.map((skill) => {
                    ...
                    return (
                      <div key={skill._id} className="space-y-1.5">
                        ...
                        {/* Accessible Proficiency Progress Bar */}
                        <div
                          role="progressbar"
                          aria-valuenow={prof}
                          aria-valuemin={0}
                        ...
                        >
                          <div
                            className="h-full rounded-full bg-linear-to-r from-[#337418] to-[#5DD62C] transition-all duration-500"
      ...
      {/* =========================================================================
          ...
          ========================================================================= */}
      <section className="rounded-2xl border border-[#337418]/60 bg-linear-to-r from-[#202020] via-[#202020] to-[#0F0F0F] p-8 sm:p-10 flex flex-col sm:flex-row items-center justify-between gap-6">
